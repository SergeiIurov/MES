...
namespace ControlBoard.DB.Migrations
{
    ...
    [Migration("20251002095033_AddedScanningPointsTable")]
    partial class AddedScanningPointsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlBoard.DB.Entities.Area", b =>
                {
                    ...
                    b.Property<string>("DisabledColor")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("red")
                        .HasColumnName("disabled_color");
            ...
            modelBuilder.Entity("ControlBoard.DB.Entities.CarExecution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ControlBoard.DB.Entities.HistoryInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("JsonInfo")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("json_info");

                    b.HasKey("Id");

                    b.ToTable("history_info", (string)null);
                });
            ...
            modelBuilder.Entity("ControlBoard.DB.Entities.ScanningPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("scanning_points", (string)null);
                });

            modelBuilder.Entity("ControlBoard.DB.Entities.Specification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("ChassisAssemblyStartDate")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("chassis_assembly_start_data");

                    b.Property<DateTime>("Created")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created");

                    b.Property<string>("DateInstallationCabinOnСhassis")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("date_installation_cabin_on_chassis");
                    ...
                    b.Property<string>("SpecificationStr")
                        .HasColumnType("text")
                        .HasColumnName("specification_str");
